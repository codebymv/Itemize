      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div className="p-3 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium italic text-gray-800 dark:text-slate-100" style={{ fontFamily: '"Raleway", sans-serif' }}>Sprint Tasks</span>
          </div>
        ...
        <div className="p-3 space-y-2">
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              <div className={`w-4 h-4 rounded border-2 flex items-center justify-center ${item.done ? 'bg-violet-500 border-violet-500' : 'border-gray-300 dark:border-slate-600'}`}>
                {item.done && <Check className="h-3 w-3 text-white" />}
              </div>
              <span className={`text-sm ${item.done ? 'line-through opacity-50' : ''} text-gray-700 dark:text-slate-300`}>{item.text}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div className="p-3 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium italic text-gray-800 dark:text-slate-100" style={{ fontFamily: '"Raleway", sans-serif' }}>Meeting Notes</span>
          </div>
          <ChevronDown className="h-4 w-4 text-gray-400 dark:text-slate-500" />
        </div>
        <div className="p-3">
          <div className="text-sm space-y-2 text-gray-600 dark:text-slate-400">
            <p className="font-medium text-gray-800 dark:text-slate-200">Key Takeaways:</p>
            <ul className="text-xs space-y-1 ml-4 list-disc">
              <li>Budget approved for Q2</li>
              <li>Timeline: 2 weeks delivery</li>
              <li>Next step: send proposal</li>
            </ul>
            <p className="text-xs mt-3 pt-2 border-t border-gray-200 dark:border-slate-700">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
        <div className="p-3 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium italic text-gray-800 dark:text-slate-100" style={{ fontFamily: '"Raleway", sans-serif' }}>Brainstorm</span>
          </div>
          <ChevronDown className="h-4 w-4 text-gray-400 dark:text-slate-500" />
        </div>
        <div className="flex-1 bg-gray-50 dark:bg-slate-900/50 p-4 flex flex-col items-center justify-center relative min-h-[200px]">
          ...
          <Palette className="h-10 w-10 text-gray-300 dark:text-slate-600" />
          <span className="text-xs mt-2 text-gray-400 dark:text-slate-500">Draw & annotate</span>
        </div>
      </div>
    </div>
  );
