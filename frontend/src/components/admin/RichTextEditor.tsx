    ...
    const ToolbarButton = ({
        ...
        <button
            ...
            className={cn(
                ...
                isActive ? 'bg-theme-tint text-primary dark:bg-theme-tint/50 dark:text-icon-accent' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-800'
            )}
            title={title}
            type="button"
            disabled={disabled}
                        ...
                        <div className="absolute top-full left-0 mt-1 w-40 bg-white dark:bg-slate-900 rounded-md shadow-lg z-50 border border-slate-200 dark:border-slate-700 overflow-hidden">
                            <button
                                ...
                                className={cn(
                                    ...
                                    editor?.isActive('heading', { level: 1 }) && 'bg-theme-tint text-primary dark:bg-theme-tint/30 dark:text-icon-accent'
                                )}
                            >
                                Heading 1
                            </button>
                            <button
                                ...
                                className={cn(
                                    ...
                                    editor?.isActive('heading', { level: 2 }) && 'bg-theme-tint text-primary dark:bg-theme-tint/30 dark:text-icon-accent'
                                )}
                            >
                                Heading 2
                            </button>
                            <button
                                ...
                                className={cn(
                                    ...
                                    editor?.isActive('heading', { level: 3 }) && 'bg-theme-tint text-primary dark:bg-theme-tint/30 dark:text-icon-accent'
                                )}
                            >
                                Heading 3
                            </button>
                            <button
                                ...
                                className={cn(
                                    ...
                                    !editor?.isActive('heading') && 'bg-theme-tint text-primary dark:bg-theme-tint/30 dark:text-icon-accent'
                                )}
                            >
                                Paragraph
                            </button>
                        ...
                        <div className="absolute top-full right-0 mt-1 w-64 p-3 bg-white dark:bg-slate-900 rounded-md shadow-lg z-50 border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="flex items-center justify-between">
                                <button
                                    ...
                                    className="px-3 py-1.5 bg-primary text-primary-foreground rounded text-sm interaction-button--primary"
                                >
                                    Apply
                                </button>
                                <button
                        ...
                        <div className="absolute top-full right-0 mt-1 w-64 p-3 bg-white dark:bg-slate-900 rounded-md shadow-lg z-50 border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="flex items-center justify-between">
                                <button
                                    ...
                                    className="px-3 py-1.5 bg-primary text-primary-foreground rounded text-sm interaction-button--primary disabled:opacity-50"
                                >
                                    Insert
                                </button>
                                <button
