                ...
                >
                    <SidebarMenuItem className={cn(isCollapsed && "flex justify-center")}>
                        <CollapsibleTrigger asChild>
                            ...
                            >
                                <item.icon className={cn("h-4 w-4 transition-colors", isActive ? "text-icon-accent" : "text-gray-600 dark:text-gray-400 group-hover/item:text-icon-accent group-focus-visible/item:text-icon-accent")} />
                                ...
                                >
                                    <SidebarMenuItem className={cn(isCollapsed && "flex justify-center")}>
                                        <CollapsibleTrigger asChild>
                                            ...
                                            >
                                                <Ellipsis className={cn("h-4 w-4 transition-colors", isMoreToolsRouteActive ? "text-icon-accent" : "text-gray-600 dark:text-gray-400 group-hover/item:text-icon-accent group-focus-visible/item:text-icon-accent")} />
