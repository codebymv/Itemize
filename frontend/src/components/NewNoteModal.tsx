...
export const NewNoteModal: React.FC<NewNoteModalProps> = ({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onCreateNote(title.trim(), finalCategory, color, initialPosition);
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="noteTitle" style={{ fontFamily: '"Raleway", sans-serif' }}>Title</Label>
            <Input
              id="noteTitle"
              value={title}
          ...
          <div className="grid grid-cols-[1fr_60px] gap-4 items-start">
            ...
            {!isAddingNewCategory ? (
              <div className="space-y-2">
                <Label htmlFor="noteCategory" style={{ fontFamily: '"Raleway", sans-serif' }}>Category</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="newNoteCategory" style={{ fontFamily: '"Raleway", sans-serif' }}>New Category</Label>
