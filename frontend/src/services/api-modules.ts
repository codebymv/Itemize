...
export const invoicesApi = {
  ...
  createInvoice: async (data: ApiPayload) => {
    const response = await api.post('/api/invoices', data)
    return unwrapResponse(response.data)
  },

  updateInvoice: async (id: string, data: ApiPayload) => {
...
export const signaturesApi = {
  ...
  createSignature: async (data: ApiPayload) => {
    const response = await api.post('/api/signatures', data)
    return unwrapResponse(response.data)
  },

  updateSignature: async (id: string, data: ApiPayload) => {
...
export const workflowsApi = {
  ...
  createWorkflow: async (data: ApiPayload) => {
    const response = await api.post('/api/workflows', data)
    return unwrapResponse(response.data)
  },

  updateWorkflow: async (id: string, data: ApiPayload) => {
  ...
  triggerWorkflow: async (id: string, eventType: string, eventData: ApiPayload) => {
