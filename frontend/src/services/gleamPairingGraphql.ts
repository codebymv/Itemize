...
const fields = 'enabled organizationId organizationName assignees{id name} pairing{id state source_name connection_id connection_state expires_at default_assignee_id due_after_minutes}';
