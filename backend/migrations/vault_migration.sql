...
-- Vaults table (main container for encrypted items)
CREATE TABLE IF NOT EXISTS vaults (
    ...
    master_password_hash VARCHAR(255),  -- Optional bcrypt hash for master password
...
-- Vault items table (individual encrypted entries)
CREATE TABLE IF NOT EXISTS vault_items (
    ...
    iv VARCHAR(255) NOT NULL,  -- Initialization vector for AES-GCM
