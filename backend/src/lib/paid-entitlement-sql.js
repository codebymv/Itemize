 ...
 * request context. Keep this aligned with backend-v2 hasPaidEntitlement().
 */
function paidEntitlementSql(organizationAlias = 'organization') {
...
module.exports = { paidEntitlementSql };
