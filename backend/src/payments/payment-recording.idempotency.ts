...
import type { RecordPaymentValues } from './payments.repository';

const IDEMPOTENCY_KEY = /^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$/;

export type PaymentRecordingAction =
  | 'record_payment'
...
export const paymentRecordingFingerprint = (
...
export const paymentRecordingKey = (value: string): string => {
