...
**Status:** Authenticated calendar reads, definition mutations including deletion, and weekly availability browser-gated; authenticated booking reads and date-override adapters integration-proven
