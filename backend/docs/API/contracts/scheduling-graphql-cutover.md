...
**Status:** Authenticated calendar and booking reads, authenticated booking cancellation, calendar definition mutations including deletion, and weekly availability browser-gated; authenticated booking create/reschedule and date-override adapters implementation/integration-proven
...
3. the remaining calendar-delete null/reference semantics are frozen; authenticated booking create/reschedule/cancellation references and lifecycle transitions, booking read projections, and calendar definition/availability/override semantics are now covered;
...
6. worker-consumer retry/idempotency is frozen for the now-versioned create/reschedule/cancellation events;
7. create/reschedule plus the remaining GraphQL operations, retained HTTP protocols, and critical calendar/public-booking/provider journeys pass semantic parity and rollback tests.
