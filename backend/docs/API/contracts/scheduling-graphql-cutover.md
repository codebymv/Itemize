...
**Status:** Authenticated calendar and booking reads, calendar definition mutations including deletion, and weekly availability browser-gated; date-override adapters and authenticated booking cancellation implementation/integration-proven
