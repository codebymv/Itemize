...
Standalone payment-link creation and logo deletion/storage lifecycle still lack sufficient executable characterization. Deployment configuration, including scheduling the one-shot delivery commands, remains deferred.
