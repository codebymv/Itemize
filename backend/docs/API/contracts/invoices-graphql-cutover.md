...
Settings, logo deletion/storage lifecycle, email preview, payment-link creation, estimate send, and scheduled recurring generation behavior still lack sufficient executable characterization. Provider behavior and deployment configuration remain deferred.
