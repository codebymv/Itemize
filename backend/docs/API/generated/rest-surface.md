...
- Route declarations: 426
- Resolved declarations: 426
...
| GET | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:83` |
| POST | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:212` |
| GET | `/api/bookings/:id` | `/:id` | `backend/src/routes/bookings.routes.js:181` |
| PATCH | `/api/bookings/:id/cancel` | `/:id/cancel` | `backend/src/routes/bookings.routes.js:331` |
| PATCH | `/api/bookings/:id/reschedule` | `/:id/reschedule` | `backend/src/routes/bookings.routes.js:379` |
| GET | `/api/bookings/public/book/:slug` | `/public/book/:slug` | `backend/src/routes/bookings.routes.js:501` |
| POST | `/api/bookings/public/book/:slug` | `/public/book/:slug` | `backend/src/routes/bookings.routes.js:616` |
| POST | `/api/bookings/public/book/:slug/cancel/:token` | `/public/book/:slug/cancel/:token` | `backend/src/routes/bookings.routes.js:798` |
| GET | `/api/bookings/public/book/:slug/slots` | `/public/book/:slug/slots` | `backend/src/routes/bookings.routes.js:548` |
...
| GET | `/api/contacts/export/csv` | `/api/contacts/export/csv` | `backend/src/bootstrap/register-api-routes.js:212` |
| GET | `/api/contacts/export/csv` | `/export/csv` | `backend/src/routes/contacts.routes.js:749` |
| POST | `/api/contacts/import/csv` | `/api/contacts/import/csv` | `backend/src/bootstrap/register-api-routes.js:213` |
...
| GET | `/api/status` | `/api/status` | `backend/src/bootstrap/register-api-routes.js:114` |
| POST | `/api/suggestions` | `/api/suggestions` | `backend/src/bootstrap/register-api-routes.js:58` |
...
| PUT | `/api/vaults/:vaultId/position` | `/api/vaults/:vaultId/position` | `backend/src/bootstrap/register-api-routes.js:49` |
