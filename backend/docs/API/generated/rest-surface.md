...
| GET | `/api/calendar-integrations/connections` | `/connections` | `backend/src/routes/calendar-integrations.routes.js:41` |
| DELETE | `/api/calendar-integrations/connections/:id` | `/connections/:id` | `backend/src/routes/calendar-integrations.routes.js:64` |
| PATCH | `/api/calendar-integrations/connections/:id` | `/connections/:id` | `backend/src/routes/calendar-integrations.routes.js:87` |
| GET | `/api/calendar-integrations/google/auth` | `/google/auth` | `backend/src/routes/calendar-integrations.routes.js:128` |
| GET | `/api/calendar-integrations/google/calendars/:connectionId` | `/google/calendars/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:255` |
| GET | `/api/calendar-integrations/google/callback` | `/google/callback` | `backend/src/routes/calendar-integrations.routes.js:148` |
| GET | `/api/calendar-integrations/sync-status/:connectionId` | `/sync-status/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:341` |
| POST | `/api/calendar-integrations/sync/:connectionId` | `/sync/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:286` |
