...
The latest 2026-07-21 clean-schema checkpoint verified 106 expected tables and 80 top-level migration markers. The complete retained baseline is 30 legacy suites with a 489-test pass. The 24 NestJS GraphQL/retained-HTTP suites pass 197 tests; the reputation contract now proves provider-confirmed idempotent send/bulk/resend delivery, worker ownership, ambiguous-SMS quarantine, active-delivery deletion protection, canonical public links, and concurrent single-commit public submission.
