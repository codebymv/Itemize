...
The latest 2026-07-19 run verified 97 expected tables and 72 top-level migration markers. The complete retained baseline is 29 legacy suites with 486 tests, and the focused fresh run passed both scheduling suites with 37 tests before all 10 NestJS GraphQL suites passed 94 tests.
