...
The latest 2026-07-22 clean-schema checkpoint verified 106 expected tables and 79 top-level migration markers. The complete retained baseline is 30 legacy suites with a 489-test pass. The 25 NestJS GraphQL/retained-HTTP suites pass 202 tests; the reputation contracts now prove provider-confirmed idempotent send/bulk/resend delivery, worker ownership, ambiguous-SMS quarantine, active-delivery deletion protection, canonical public links, concurrent single-commit public submission, authenticated platform/settings/widget interoperability, credential-field omission, tenant concealment, atomic settings validation, and revocable public widget capabilities.
