...
The latest 2026-07-19 run verified 97 expected tables and 70 top-level migration markers, passed all 28 legacy suites with 480 tests, and then passed all 10 NestJS GraphQL suites with 94 tests.
