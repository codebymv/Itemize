...
| GET | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:68` |
| POST | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:197` |
| GET | `/api/bookings/:id` | `/:id` | `backend/src/routes/bookings.routes.js:166` |
| PATCH | `/api/bookings/:id/cancel` | `/:id/cancel` | `backend/src/routes/bookings.routes.js:301` |
...
| GET | `/api/forms` | `/` | `backend/src/routes/forms.routes.js:73` |
| POST | `/api/forms` | `/` | `backend/src/routes/forms.routes.js:144` |
| DELETE | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:487` |
| GET | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:106` |
| PUT | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:312` |
| POST | `/api/forms/:id/duplicate` | `/:id/duplicate` | `backend/src/routes/forms.routes.js:511` |
| PUT | `/api/forms/:id/fields` | `/:id/fields` | `backend/src/routes/forms.routes.js:380` |
| GET | `/api/forms/:id/submissions` | `/:id/submissions` | `backend/src/routes/forms.routes.js:649` |
| DELETE | `/api/forms/:id/submissions/:subId` | `/:id/submissions/:subId` | `backend/src/routes/forms.routes.js:712` |
| GET | `/api/forms/public/form/:slug` | `/public/form/:slug` | `backend/src/routes/forms.routes.js:741` |
| POST | `/api/forms/public/form/:slug` | `/public/form/:slug` | `backend/src/routes/forms.routes.js:786` |
