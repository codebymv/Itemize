...
| GET | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:67` |
| POST | `/api/bookings` | `/` | `backend/src/routes/bookings.routes.js:196` |
| GET | `/api/bookings/:id` | `/:id` | `backend/src/routes/bookings.routes.js:165` |
| PATCH | `/api/bookings/:id/cancel` | `/:id/cancel` | `backend/src/routes/bookings.routes.js:300` |
| PATCH | `/api/bookings/:id/reschedule` | `/:id/reschedule` | `backend/src/routes/bookings.routes.js:348` |
| GET | `/api/bookings/public/book/:slug` | `/public/book/:slug` | `backend/src/routes/bookings.routes.js:432` |
| POST | `/api/bookings/public/book/:slug` | `/public/book/:slug` | `backend/src/routes/bookings.routes.js:562` |
| POST | `/api/bookings/public/book/:slug/cancel/:token` | `/public/book/:slug/cancel/:token` | `backend/src/routes/bookings.routes.js:713` |
| GET | `/api/bookings/public/book/:slug/slots` | `/public/book/:slug/slots` | `backend/src/routes/bookings.routes.js:479` |
...
| PATCH | `/api/calendar-integrations/connections/:id` | `/connections/:id` | `backend/src/routes/calendar-integrations.routes.js:75` |
| GET | `/api/calendar-integrations/google/auth` | `/google/auth` | `backend/src/routes/calendar-integrations.routes.js:116` |
| GET | `/api/calendar-integrations/google/calendars/:connectionId` | `/google/calendars/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:236` |
| GET | `/api/calendar-integrations/google/callback` | `/google/callback` | `backend/src/routes/calendar-integrations.routes.js:136` |
| GET | `/api/calendar-integrations/sync-status/:connectionId` | `/sync-status/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:359` |
| POST | `/api/calendar-integrations/sync/:connectionId` | `/sync/:connectionId` | `backend/src/routes/calendar-integrations.routes.js:283` |
...
| POST | `/api/campaigns/:id/pause` | `/:id/pause` | `backend/src/routes/campaigns/actions.routes.js:267` |
...
| POST | `/api/campaigns/:id/resume` | `/:id/resume` | `backend/src/routes/campaigns/actions.routes.js:294` |
...
| PUT | `/api/canvas/positions` | `/api/canvas/positions` | `backend/src/bootstrap/register-api-routes.js:49` |
...
| GET | `/api/contacts` | `/` | `backend/src/routes/contacts.routes.js:106` |
| POST | `/api/contacts` | `/` | `backend/src/routes/contacts.routes.js:224` |
| DELETE | `/api/contacts/:id` | `/:id` | `backend/src/routes/contacts.routes.js:438` |
| GET | `/api/contacts/:id` | `/:id` | `backend/src/routes/contacts.routes.js:200` |
| PUT | `/api/contacts/:id` | `/:id` | `backend/src/routes/contacts.routes.js:321` |
| GET | `/api/contacts/:id/activities` | `/:id/activities` | `backend/src/routes/contacts.routes.js:611` |
| POST | `/api/contacts/:id/activities` | `/:id/activities` | `backend/src/routes/contacts.routes.js:656` |
| GET | `/api/contacts/:id/content` | `/:id/content` | `backend/src/routes/contacts.routes.js:704` |
| GET | `/api/contacts/:id/profile` | `/:id/profile` | `backend/src/routes/contact-profile.routes.js:14` |
| POST | `/api/contacts/bulk-delete` | `/bulk-delete` | `backend/src/routes/contacts.routes.js:589` |
| POST | `/api/contacts/bulk-update` | `/bulk-update` | `backend/src/routes/contacts.routes.js:456` |
| GET | `/api/contacts/export/csv` | `/export/csv` | `backend/src/routes/contacts.routes.js:748` |
| POST | `/api/contacts/import/csv` | `/import/csv` | `backend/src/routes/contacts.routes.js:831` |
...
| GET | `/api/forms` | `/` | `backend/src/routes/forms.routes.js:72` |
| POST | `/api/forms` | `/` | `backend/src/routes/forms.routes.js:143` |
| DELETE | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:486` |
| GET | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:105` |
| PUT | `/api/forms/:id` | `/:id` | `backend/src/routes/forms.routes.js:311` |
| POST | `/api/forms/:id/duplicate` | `/:id/duplicate` | `backend/src/routes/forms.routes.js:510` |
| PUT | `/api/forms/:id/fields` | `/:id/fields` | `backend/src/routes/forms.routes.js:379` |
| GET | `/api/forms/:id/submissions` | `/:id/submissions` | `backend/src/routes/forms.routes.js:648` |
...
| PUT | `/api/lists/:id/position` | `/api/lists/:id/position` | `backend/src/bootstrap/register-api-routes.js:45` |
...
| GET | `/api/pipelines` | `/` | `backend/src/routes/pipelines.routes.js:95` |
| POST | `/api/pipelines` | `/` | `backend/src/routes/pipelines.routes.js:159` |
| DELETE | `/api/pipelines/:id` | `/:id` | `backend/src/routes/pipelines.routes.js:296` |
| GET | `/api/pipelines/:id` | `/:id` | `backend/src/routes/pipelines.routes.js:116` |
| PUT | `/api/pipelines/:id` | `/:id` | `backend/src/routes/pipelines.routes.js:216` |
| POST | `/api/pipelines/deals` | `/deals` | `backend/src/routes/pipelines.routes.js:473` |
| DELETE | `/api/pipelines/deals/:id` | `/deals/:id` | `backend/src/routes/pipelines.routes.js:798` |
| GET | `/api/pipelines/deals/:id` | `/deals/:id` | `backend/src/routes/pipelines.routes.js:443` |
| PUT | `/api/pipelines/deals/:id` | `/deals/:id` | `backend/src/routes/pipelines.routes.js:549` |
| POST | `/api/pipelines/deals/:id/lost` | `/deals/:id/lost` | `backend/src/routes/pipelines.routes.js:743` |
| POST | `/api/pipelines/deals/:id/reopen` | `/deals/:id/reopen` | `backend/src/routes/pipelines.routes.js:771` |
| PATCH | `/api/pipelines/deals/:id/stage` | `/deals/:id/stage` | `backend/src/routes/pipelines.routes.js:640` |
| POST | `/api/pipelines/deals/:id/won` | `/deals/:id/won` | `backend/src/routes/pipelines.routes.js:716` |
| GET | `/api/pipelines/deals/all` | `/deals/all` | `backend/src/routes/pipelines.routes.js:348` |
| GET | `/api/preview/version/:versionId` | `/version/:versionId` | `backend/src/routes/preview.routes.js:24` |
| GET | `/api/public/sign/:token` | `/public/sign/:token` | `backend/src/routes/signatures.routes.js:559` |
| POST | `/api/public/sign/:token` | `/public/sign/:token` | `backend/src/routes/signatures.routes.js:586` |
| POST | `/api/public/sign/:token/decline` | `/public/sign/:token/decline` | `backend/src/routes/signatures.routes.js:617` |
| GET | `/api/public/sign/:token/download` | `/public/sign/:token/download` | `backend/src/routes/signatures.routes.js:631` |
| GET | `/api/public/sign/:token/file` | `/public/sign/:token/file` | `backend/src/routes/signatures.routes.js:648` |
| POST | `/api/public/sign/:token/verify` | `/public/sign/:token/verify` | `backend/src/routes/signatures.routes.js:582` |
...
| GET | `/api/signatures/documents/:id` | `/signatures/documents/:id` | `backend/src/routes/signatures.routes.js:441` |
| PUT | `/api/signatures/documents/:id` | `/signatures/documents/:id` | `backend/src/routes/signatures.routes.js:305` |
| GET | `/api/signatures/documents/:id/audit` | `/signatures/documents/:id/audit` | `backend/src/routes/signatures.routes.js:548` |
| POST | `/api/signatures/documents/:id/cancel` | `/signatures/documents/:id/cancel` | `backend/src/routes/signatures.routes.js:470` |
| GET | `/api/signatures/documents/:id/download` | `/signatures/documents/:id/download` | `backend/src/routes/signatures.routes.js:518` |
| DELETE | `/api/signatures/documents/:id/file` | `/signatures/documents/:id/file` | `backend/src/routes/signatures.routes.js:408` |
| GET | `/api/signatures/documents/:id/file` | `/signatures/documents/:id/file` | `backend/src/routes/signatures.routes.js:535` |
| POST | `/api/signatures/documents/:id/remind` | `/signatures/documents/:id/remind` | `backend/src/routes/signatures.routes.js:482` |
| POST | `/api/signatures/documents/:id/reminders` | `/signatures/documents/:id/reminders` | `backend/src/routes/signatures.routes.js:502` |
| POST | `/api/signatures/documents/:id/send` | `/signatures/documents/:id/send` | `backend/src/routes/signatures.routes.js:448` |
| POST | `/api/signatures/documents/upload` | `/signatures/documents/upload` | `backend/src/routes/signatures.routes.js:348` |
| POST | `/api/signatures/email/preview` | `/signatures/email/preview` | `backend/src/routes/signatures.routes.js:385` |
| GET | `/api/signatures/templates` | `/signatures/templates` | `backend/src/routes/signatures.routes.js:242` |
| POST | `/api/signatures/templates` | `/signatures/templates` | `backend/src/routes/signatures.routes.js:163` |
| DELETE | `/api/signatures/templates/:id` | `/signatures/templates/:id` | `backend/src/routes/signatures.routes.js:198` |
| GET | `/api/signatures/templates/:id` | `/signatures/templates/:id` | `backend/src/routes/signatures.routes.js:247` |
| PUT | `/api/signatures/templates/:id` | `/signatures/templates/:id` | `backend/src/routes/signatures.routes.js:172` |
| GET | `/api/signatures/templates/:id/file` | `/signatures/templates/:id/file` | `backend/src/routes/signatures.routes.js:254` |
| POST | `/api/signatures/templates/:id/instantiate` | `/signatures/templates/:id/instantiate` | `backend/src/routes/signatures.routes.js:267` |
| POST | `/api/signatures/templates/upload` | `/signatures/templates/upload` | `backend/src/routes/signatures.routes.js:210` |
...
| GET | `/api/status` | `/api/status` | `backend/src/bootstrap/register-api-routes.js:113` |
| POST | `/api/suggestions` | `/api/suggestions` | `backend/src/bootstrap/register-api-routes.js:57` |
| GET | `/api/tags` | `/` | `backend/src/routes/tags.routes.js:22` |
| POST | `/api/tags` | `/` | `backend/src/routes/tags.routes.js:55` |
| DELETE | `/api/tags/:id` | `/:id` | `backend/src/routes/tags.routes.js:163` |
| PUT | `/api/tags/:id` | `/:id` | `backend/src/routes/tags.routes.js:96` |
| GET | `/api/tags/suggestions` | `/suggestions` | `backend/src/routes/tags.routes.js:214` |
...
| PUT | `/api/vaults/:vaultId/position` | `/api/vaults/:vaultId/position` | `backend/src/bootstrap/register-api-routes.js:48` |
...
| PUT | `/api/whiteboards/:id/position` | `/api/whiteboards/:id/position` | `backend/src/bootstrap/register-api-routes.js:46` |
...
| PUT | `/api/wireframes/:id/position` | `/api/wireframes/:id/position` | `backend/src/bootstrap/register-api-routes.js:47` |
