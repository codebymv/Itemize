...
Settings, logo deletion/storage lifecycle, email preview, payment-link creation, and estimate send still lack sufficient executable characterization. Provider behavior and deployment configuration, including scheduling the one-shot command, remain deferred.
