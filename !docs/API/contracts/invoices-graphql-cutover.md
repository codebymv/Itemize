...
Logo deletion/storage lifecycle, payment-link creation, and estimate send still lack sufficient executable characterization. Provider behavior and deployment configuration, including scheduling the one-shot command, remain deferred.
