...
Logo deletion/storage lifecycle and payment-link creation still lack sufficient executable characterization. Deployment configuration, including scheduling the one-shot commands, remains deferred.
