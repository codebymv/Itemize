...
**Status:** Authenticated retained HTTP targets implemented for contact transfer, invoice PDF, invoice-logo upload, and signature upload/private delivery; public signature files remain characterized
