...
**Status:** Session plus registration/verification enabled; password recovery, password change, and viewer profile implemented behind independent rollback boundaries
