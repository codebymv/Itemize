...
**Status:** Authenticated calendar reads and definition create/update browser-gated; availability/date-override checkpoint implemented and awaiting staging gate
...
3. booking assignee/contact references and the remaining calendar-delete null/reference semantics are tenant-validated and frozen; calendar definition, availability, and override semantics are now covered;
