...
7. credential login, a user-facing organization-switching workflow, mutations, and remaining contact/pipeline/form browser journeys pass semantic parity and rollback tests.
