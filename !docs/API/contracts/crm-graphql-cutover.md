...
7. the instrumented contact-mutation staging observation window completes, and remaining pipeline/form browser journeys pass staging semantic-parity tests.
